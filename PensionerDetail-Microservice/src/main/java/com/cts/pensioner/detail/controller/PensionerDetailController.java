...
public class PensionerDetailController {
	...
	public PensionerDetail getPensionerDetailByAadhar(
			...
			@PathVariable long aadharNumber) 
	{
		
				return pensionerDetailServiceImpl.getPensionerDetailByAadharCard(requestTokenHeader,aadharNumber,authorisingClient);
			...
			@RequestHeader(value = "Authorization", required = true) String requestTokenHeader) 
	{
		...
		return pensionerDetailServiceImpl.getAllPensioner(requestTokenHeader,authorisingClient);
