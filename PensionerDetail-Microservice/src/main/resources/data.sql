insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (420559429031,'Pallav','1999-01-04','SBIN0000388',29000,1200,'self','SBI',9029856585,'private');
...
insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (320559431029,'Kishor','1999-06-13','SBIN0000116',27000,1000,'self','SBI',8130585625,'private');
--
...
insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (110005635647,'Rohan','1999-11-17','SHTOC34253',65000,8000,'self','Indian Bank',6396453455,'public');

insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (675647365647,'Deepanshu','1998-10-13','SHTOC34253',70000,8000,'self','Indian Bank',6396434565,'public');
...
insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (656456785634,'Deepika','1999-09-21','PCQAZ1285Q',30000,12000,'family','SBI',6396235677,'public');
...
insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (123456765765,'Kritika','1998-12-05','GHFFM67983',55000,2000,'family','ICICI',7340656756,'private');

insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (140023455765,'Shrey','1999-05-22','SHTOC34253',65000,8000,'family','HDFC',9917456756,'public');

insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (785647376767,'Vivek','1999-04-23','TYUO109874',26000,1000,'self','HSBC',7017653423,'private');

insert into pensioner (aadhar, name, dob, pan,salary,allowances,pension,bank,accnumber,banktype) values (120034523767,'Harsh','1998-07-15','BHMER12436',29500,1100,'self','HDFC',7017653423,'private');